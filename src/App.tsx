...
const ENERGY_TYPES: EnergyInfo[] = [
  // Atomic Matter
  { id: 'atom', label: 'อะตอม', icon: <Atom size={16} />, color: '#00ffff', desc: 'หน่วยพื้นฐานของสสาร', category: 'atomic', mass: 10, charge: 0, speed: 1, stability: 0.9, heat: 300 },
  { id: 'proton', label: 'โปรตอน', icon: <PlusCircle size={16} />, color: '#ff0000', desc: 'อนุภาคประจุบวก', category: 'atomic', mass: 5, charge: 1, speed: 2, stability: 1.0, heat: 500 },
  { id: 'neutron', label: 'นิวตรอน', icon: <MinusCircle size={16} />, color: '#808080', desc: 'อนุภาคที่เป็นกลาง', category: 'atomic', mass: 5, charge: 0, speed: 2, stability: 1.0, heat: 500 },
  { id: 'electron', label: 'อิเล็กตรอน', icon: <Zap size={16} />, color: '#ffff00', desc: 'อนุภาคประจุลบ', category: 'atomic', mass: 0.1, charge: -1, speed: 10, stability: 0.8, heat: 1000 },
  { id: 'ion', label: 'ไอออน', icon: <CircleDashed size={16} />, color: '#adff2f', desc: 'อะตอมที่มีประจุ', category: 'atomic', mass: 10, charge: 2, speed: 3, stability: 0.7, heat: 800 },
  { id: 'plasma-atom', label: 'อะตอมพลาสมา', icon: <Sun size={16} />, color: '#ffa500', desc: 'ก๊าซที่มีประจุไฟฟ้าสูง', category: 'atomic', mass: 8, charge: 3, speed: 5, stability: 0.5, heat: 5000 },
  { id: 'radioactive-core', label: 'แกนกัมมันตรังสี', icon: <Activity size={16} />, color: '#32cd32', desc: 'แกนกลางที่ไม่เสถียร', category: 'atomic', mass: 20, charge: 0, speed: 1, stability: 0.2, heat: 2000 },

  // Subatomic Particle
  { id: 'quark', label: 'ควาร์ก', icon: <Sparkles size={16} />, color: '#ff1493', desc: 'อนุภาคพื้นฐานของสสาร', category: 'subatomic', mass: 0.5, charge: 0.66, speed: 15, stability: 0.4, heat: 10000 },
  { id: 'boson', label: 'โบซอน', icon: <Atom size={16} />, color: '#00fa9a', desc: 'อนุภาคตัวกลางของแรง', category: 'subatomic', mass: 0, charge: 0, speed: 20, stability: 0.3, heat: 15000 },
  { id: 'higgs-field', label: 'สนามฮิกส์', icon: <Layers size={16} />, color: '#ee82ee', desc: 'สนามที่ให้มวลแก่อนุภาค', category: 'subatomic', mass: 0, charge: 0, speed: 0, stability: 1.0, heat: 0 },
  { id: 'neutrino', label: 'นิวทริโน', icon: <Zap size={16} />, color: '#f0e68c', desc: 'อนุภาคที่มีมวลน้อยมาก', category: 'subatomic', mass: 0.0001, charge: 0, speed: 25, stability: 0.9, heat: 100 },
  { id: 'muon', label: 'มิวออน', icon: <Activity size={16} />, color: '#00bfff', desc: 'อนุภาคคล้ายอิเล็กตรอนแต่หนักกว่า', category: 'subatomic', mass: 2, charge: -1, speed: 8, stability: 0.1, heat: 500 },
  { id: 'gluon', label: 'กลูออน', icon: <Magnet size={16} />, color: '#ff4500', desc: 'อนุภาคยึดเหนี่ยวควาร์ก', category: 'subatomic', mass: 0, charge: 0, speed: 20, stability: 0.5, heat: 20000 },
  { id: 'tachyon', label: 'ทาคีออน', icon: <Wind size={16} />, color: '#ffffff', desc: 'อนุภาคสมมุติที่เร็วกว่าแสง', category: 'subatomic', mass: -1, charge: 0, speed: 50, stability: 0.0, heat: 50000 },

  // Cosmic Energy
  { id: 'solar', label: 'พลังงานสุริยะ', icon: <Sun size={16} />, color: '#ffd700', desc: 'พลังงานจากดวงอาทิตย์', category: 'cosmic', mass: 0, charge: 0, speed: 10, stability: 0.8, heat: 6000 },
  { id: 'lunar', label: 'พลังงานจันทรา', icon: <Moon size={16} />, color: '#f5f5f5', desc: 'พลังงานจากดวงจันทร์', category: 'cosmic', mass: 0, charge: 0, speed: 5, stability: 0.9, heat: -100 },
  { id: 'stellar', label: 'แกนดาวฤกษ์', icon: <StarIcon size={16} />, color: '#fffacd', desc: 'พลังงานจากดาวฤกษ์', category: 'cosmic', mass: 100, charge: 0, speed: 1, stability: 0.7, heat: 15000000 },
  { id: 'nebula', label: 'เมฆเนบิวลา', icon: <Cloud size={16} />, color: '#da70d6', desc: 'กลุ่มก๊าซในอวกาศ', category: 'cosmic', mass: 50, charge: 0, speed: 0.5, stability: 0.6, heat: 10000 },
  { id: 'cosmic-ray', label: 'รังสีคอสมิก', icon: <Zap size={16} />, color: '#e6e6fa', desc: 'รังสีพลังงานสูงจากอวกาศ', category: 'cosmic', mass: 0, charge: 0, speed: 30, stability: 0.5, heat: 100000 },
  { id: 'dark-matter', label: 'สสารมืด', icon: <Layers size={16} />, color: '#2f4f4f', desc: 'สสารที่มองไม่เห็น', category: 'cosmic', mass: 500, charge: 0, speed: 2, stability: 1.0, heat: -273 },
  { id: 'dark-energy', label: 'พลังงานมืด', icon: <Wind size={16} />, color: '#4b0082', desc: 'แรงผลักดันจักรวาล', category: 'cosmic', mass: 0, charge: 0, speed: 40, stability: 1.0, heat: 0 },
  { id: 'black-hole', label: 'สนามหลุมดำ', icon: <CircleDashed size={16} />, color: '#000000', desc: 'แรงดึงดูดมหาศาล', category: 'cosmic', mass: 10000, charge: 0, speed: 0, stability: 0.1, heat: 0 },
  { id: 'supernova', label: 'ซูเปอร์โนวา', icon: <Flame size={16} />, color: '#ff4500', desc: 'การระเบิดของดาว', category: 'cosmic', mass: 1000, charge: 0, speed: 20, stability: 0.0, heat: 100000000 },

  // Elemental Energy
  { id: 'fire', label: 'ไฟ', icon: <Flame size={16} />, color: '#ff4500', desc: 'พลังงานความร้อน', category: 'elemental', mass: 0.1, charge: 0, speed: 5, stability: 0.5, heat: 1000 },
  { id: 'water', label: 'น้ำ', icon: <Waves size={16} />, color: '#00bfff', desc: 'พลังงานที่ไหลลื่น', category: 'elemental', mass: 1, charge: 0, speed: 3, stability: 0.8, heat: 25 },
  { id: 'wind', label: 'ลม', icon: <Wind size={16} />, color: '#f0f8ff', desc: 'กระแสอากาศ', category: 'elemental', mass: 0.01, charge: 0, speed: 10, stability: 0.6, heat: 20 },
  { id: 'earth', label: 'ดิน', icon: <Mountain size={16} />, color: '#8b4513', desc: 'พลังงานที่มั่นคง', category: 'elemental', mass: 10, charge: 0, speed: 1, stability: 1.0, heat: 15 },
  { id: 'ice', label: 'น้ำแข็ง', icon: <Snowflake size={16} />, color: '#afeeee', desc: 'พลังงานเยือกแข็ง', category: 'elemental', mass: 2, charge: 0, speed: 2, stability: 0.9, heat: -50 },
  { id: 'lightning', label: 'สายฟ้า', icon: <Zap size={16} />, color: '#ffff00', desc: 'ประจุไฟฟ้าแรงสูง', category: 'elemental', mass: 0, charge: 10, speed: 40, stability: 0.3, heat: 30000 },
  { id: 'light', label: 'แสง', icon: <Sun size={16} />, color: '#ffffed', desc: 'พลังงานส่องสว่าง', category: 'elemental', mass: 0, charge: 0, speed: 60, stability: 1.0, heat: 5000 },
  { id: 'shadow', label: 'เงามืด', icon: <Moon size={16} />, color: '#4b0082', desc: 'พลังงานที่กลืนกินแสง', category: 'elemental', mass: 0, charge: 0, speed: 5, stability: 0.7, heat: -10 },

  // Hand Energy / Aura
  { id: 'aura-pulse', label: 'คลื่นออร่า', icon: <Activity size={16} />, color: '#ff69b4', desc: 'คลื่นพลังงานชีวิต', category: 'aura', mass: 0.5, charge: 2, speed: 4, stability: 0.8, heat: 37 },
  { id: 'palm-energy', label: 'พลังฝ่ามือ', icon: <Target size={16} />, color: '#00fa9a', desc: 'พลังงานที่รวมไว้ที่ฝ่ามือ', category: 'aura', mass: 2, charge: 5, speed: 6, stability: 0.6, heat: 40 },
  { id: 'telekinetic', label: 'สนามพลังจิต', icon: <Brain size={16} />, color: '#9370db', desc: 'พลังงานจากจิตใจ', category: 'aura', mass: 0, charge: 0, speed: 10, stability: 0.5, heat: 36 },
  { id: 'healing', label: 'พลังฟื้นฟู', icon: <Heart size={16} />, color: '#7fffd4', desc: 'พลังงานที่รักษาเซลล์', category: 'aura', mass: 0, charge: 0, speed: 2, stability: 0.9, heat: 38 },
  { id: 'force-push', label: 'แรงผลัก', icon: <ArrowDownCircle size={16} />, color: '#f08080', desc: 'แรงผลักดันจากภายใน', category: 'aura', mass: 5, charge: 0, speed: 15, stability: 0.4, heat: 45 },
  { id: 'force-pull', label: 'แรงดึง', icon: <CircleDashed size={16} />, color: '#87cefa', desc: 'แรงดึงดูดจากภายใน', category: 'aura', mass: 5, charge: 0, speed: 15, stability: 0.4, heat: 45 },
  { id: 'shield', label: 'โล่พลังงาน', icon: <Layers size={16} />, color: '#ffd700', desc: 'เกราะป้องกันพลังงาน', category: 'aura', mass: 20, charge: 0, speed: 0, stability: 1.0, heat: 30 },
  { id: 'chakra', label: 'วงแหวนพลัง', icon: <RefreshCcw size={16} />, color: '#ff8c00', desc: 'ศูนย์รวมพลังงานหมุนวน', category: 'aura', mass: 10, charge: 10, speed: 5, stability: 0.7, heat: 100 },

  // Exotic Matter
  { id: 'crystal', label: 'ผลึกพลังงาน', icon: <Gem size={16} />, color: '#00ced1', desc: 'โครงสร้างผลึกกักเก็บพลังงาน', category: 'exotic', mass: 15, charge: 5, speed: 0, stability: 0.9, heat: 20 },
  { id: 'liquid-metal', label: 'โลหะเหลว', icon: <Droplets size={16} />, color: '#778899', desc: 'โลหะที่มีความยืดหยุ่นสูง', category: 'exotic', mass: 25, charge: 2, speed: 3, stability: 0.8, heat: 100 },
  { id: 'toxic-gas', label: 'ก๊าซพิษ', icon: <Skull size={16} />, color: '#32cd32', desc: 'ก๊าซที่เป็นอันตรายต่อสิ่งมีชีวิต', category: 'exotic', mass: 0.5, charge: 0, speed: 4, stability: 0.4, heat: 50 },
  { id: 'radiation', label: 'หมอกรังสี', icon: <Activity size={16} />, color: '#ffff00', desc: 'การแผ่รังสีที่เป็นอันตราย', category: 'exotic', mass: 0, charge: 0, speed: 10, stability: 0.2, heat: 500 },
  { id: 'quantum-foam', label: 'โฟมควอนตัม', icon: <Cpu size={16} />, color: '#00ffff', desc: 'ความผันผวนของกาลอวกาศ', category: 'exotic', mass: 0, charge: 0, speed: 20, stability: 0.1, heat: 10000 },
  { id: 'anti-matter', label: 'ปฏิสสาร', icon: <RefreshCcw size={16} />, color: '#ff00ff', desc: 'สสารที่มีประจุตรงกันข้าม', category: 'exotic', mass: 1, charge: -1, speed: 10, stability: 0.0, heat: 0 },
  { id: 'energy-gel', label: 'เจลพลังงาน', icon: <Droplets size={16} />, color: '#00ff7f', desc: 'สสารกึ่งแข็งกึ่งเหลวพลังงานสูง', category: 'exotic', mass: 5, charge: 3, speed: 2, stability: 0.7, heat: 80 },
  { id: 'fractal', label: 'สสารแตกแขนง', icon: <Layers size={16} />, color: '#ff1493', desc: 'สสารที่มีโครงสร้างซับซ้อนไม่สิ้นสุด', category: 'exotic', mass: 10, charge: 0, speed: 1, stability: 0.6, heat: 200 },
];
