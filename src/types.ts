...
export type ParticleType = 
  ...
  // Atomic Matter
  | 'atom' | 'proton' | 'neutron' | 'electron' | 'ion' | 'plasma-atom' | 'radioactive-core'
  // Subatomic
  | 'boson' | 'higgs-field' | 'neutrino' | 'muon' | 'gluon' | 'tachyon'
  // Cosmic
  | 'solar' | 'lunar' | 'stellar' | 'nebula' | 'cosmic-ray' | 'dark-energy' | 'black-hole' | 'supernova'
  // Elemental
  | 'fire' | 'water' | 'wind' | 'earth' | 'ice' | 'lightning' | 'light' | 'shadow' | 'darkness'
  // Hand/Aura
  | 'aura-pulse' | 'palm-energy' | 'telekinetic' | 'healing' | 'force-push' | 'force-pull' | 'shield' | 'chakra'
  // Exotic
